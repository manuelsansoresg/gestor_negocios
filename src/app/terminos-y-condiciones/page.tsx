...
export const metadata: Metadata = {
  title: "Términos y Condiciones | Gestor de Negocios",
  description:
    "Términos y Condiciones aplicables a los servicios de gestión y acompañamiento comercial de Gestor de Negocios.",
  alternates: {
...
export default function TermsAndConditionsPage() {
  ...
  return (
    <section className="relative overflow-hidden bg-[#05070b] py-16 text-white md:py-20">
      ...
      <div
        aria-hidden="true"
        className="absolute right-[-10rem] top-[35rem] h-96 w-96 rounded-full bg-[#0b4dcc]/10 blur-[130px]"
      />
      ...
      <div className="relative mx-auto max-w-5xl px-6 md:px-10 lg:px-12">
        ...
        <header className="mt-8 border-b border-white/10 pb-10">
          ...
          <p className="mt-6 max-w-3xl text-base leading-8 text-white/60 sm:text-lg">
            Estas condiciones establecen el alcance general de los servicios de
            gestión, conexión y acompañamiento comercial ofrecidos por Gestor
            de Negocios.
          </p>
        </header>
        ...
        <article className="pt-8">
          {lines.map((rawLine, index) => {
            ...
            if (line === "TÉRMINOS Y CONDICIONES DE GESTOR DE NEGOCIOS") {
              return null;
            }
            ...
            if (line === "DECLARACIÓN DE ACEPTACIÓN") {
              return (
                <h2
                  key={index}
            ...
            if (line === "GESTOR DE NEGOCIOS") {
              return (
                <div
                  key={index}
                  className="mt-12 rounded-[1.5rem] border border-[#1668ff]/20 bg-[#0a1220] p-6"
                >
